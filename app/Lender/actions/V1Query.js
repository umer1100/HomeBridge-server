 ...
 */
 ...
 /**
  * Query and return lenders
  *
  * GET  /v1/lenders/query
  * POST /v1/lenders/query
  *
  * Must be logged in
  * Roles: ['user', 'admin']
  *
 ...
 // add to where statement
   ...
   // get lenders
   const result = await models.lender.findAndCountAll({
     where: whereStmt,
     limit: limit,
   ...
   return Promise.resolve({
     status: 200,
     success: true,
     lenders: result.rows, // all lenders
     page: page,
     limit: limit,
