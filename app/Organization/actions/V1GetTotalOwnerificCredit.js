/**
 * ORGANIZATION V1GetTotalOwnerificCredit ACTION
 */
 ...
 /**
  * Get the total ownerific credit for all users in an organization
  *
  * GET  /v1/organizations/get-total-ownerific-credit
  * POST /v1/organizations/get-total-ownerific-credit
  *
  * Must be logged in
  * Roles: ['user']
  *
  ...
  * }
  *
  * Success: Return total ownerific credit of all users
  * Errors:
  ...
  */
 async function V1GetTotalOwnerificCredit(req) {
