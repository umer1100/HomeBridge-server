/**
 * TEST EMPLOYEESYNC V1ExampleTask METHOD
 */
...
// tasks
const { V1ExampleTask } = require('../../../../app/EmployeeSync/tasks');
...
describe.skip('EmployeeSync.V1ExampleTask', async () => {
  // grab fixtures here
...
}); // END EmployeeSync.V1ExampleTask
