/**
 * TEST CREDITWALLETLOG V1ExampleTask METHOD
 */
...
// tasks
const { V1ExampleTask } = require('../../../../app/CreditWalletLog/tasks');
...
describe.skip('CreditWalletLog.V1ExampleTask', async () => {
  // grab fixtures here
...
}); // END CreditWalletLog.V1ExampleTask
