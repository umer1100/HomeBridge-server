    ...
    'creditWallet',
    {
      ...
      dollars: {
        ...
        get() {
          ...
          const rawValue = this.getDataValue(dollars);
          return Number(rawValue);
        }
      },

      walletType: {
        type: DataTypes.ENUM(['PLATFORM', 'EMPLOYER']),
        allowNull: false,
      }
    },
    {
      ...
      hooks: {
        afterUpdate(creditWallet, options) {
          sequelize.models.creditWalletLogs.create({ creditWalletId: creditWallet.id, dollars: creditWallet.dollars });
        }
      },
      indexes: []
    }
